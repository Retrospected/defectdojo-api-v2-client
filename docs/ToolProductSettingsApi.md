# djclient.ToolProductSettingsApi
...
api_instance = djclient.ToolProductSettingsApi(djclient.ApiClient(configuration))
data = djclient.ToolProductSettings() # ToolProductSettings | 
