...
api_instance = djclient.ScanSettingsApi(djclient.ApiClient(configuration))
data = djclient.ScanSettingsCreate() # ScanSettingsCreate | 
...
api_instance = djclient.ScanSettingsApi(djclient.ApiClient(configuration))
id = 56 # int | A unique integer value identifying this scan settings.
data = djclient.ScanSettings() # ScanSettings | 
